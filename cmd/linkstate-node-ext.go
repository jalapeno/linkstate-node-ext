...
import (
	...
	"www.github.com/jalapeno/linkstate-node-ext/pkg/arangodb"
	"www.github.com/jalapeno/linkstate-node-ext/pkg/kafkamessenger"
...
func init() {
	...
	// flag.StringVar(&msgSrvAddr, "message-server", "198.18.202.100:30092", "URL to the messages supplying server")
	// flag.StringVar(&dbSrvAddr, "database-server", "http://198.18.202.100:30852", "{dns name}:port or X.X.X.X:port of the graph database")
